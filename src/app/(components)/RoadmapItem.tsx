      ...
      >
        ...
        <div className='flex-col w-min border-2 p-4 min-w-200 rounded-xl pl-8 pr-8'>
          ...
          <button
            ...
            className='flex flex-row gap-1 hover:animate-bounce p-0.5 border-transparent border-b-1 hover:border-[#171A21] items-center justify-center transition-all duration-500 '
          >
        ...
        {Item.quickTips ? (
          <div className='w-80 h-60  bg-linear-to-tr from-[#00A1E0] to-[#0CAC64] flex rounded-lg justify-center items-center'>
